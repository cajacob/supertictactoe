...
//Functions
			...
			function doMouseDown(event){
				...
				doMouseDown.allowedBoard = doMouseDown.allowedBoard || 9;
                var canvas = document.getElementById("canvas_1");
                ...
                if(doMouseDown.allowedBoard != 9 && bigboard_index != doMouseDown.allowedBoard){
                	//This means that the user tried to click in a different board than allowed
                	alert("Sorry, please play in the highlighted board, correct board is " + doMouseDown.allowedBoard);
                	return;
                }
                ...
                xhr.onreadystatechange = function() 
                {
                	if(xhr.readyState == 4) //Means that the response was sent successfully
                	{
                        ...
                        if(splitData[0] == "true")
                        {
                            ...
                            doMouseDown.allowedBoard = highlight_index;
                            repaint(highlight_index);
                            doMouseDown.user++;
                        }
                        else{
	       ...
	       function drawMiniBoards(){
            ...
            function repaint(highlight_index){   	
            	//First highlight
                var c = document.getElementById("canvas_1");
                var ctx = c.getContext("2d");     
                ...
                highlightBoard(highlight_index);
